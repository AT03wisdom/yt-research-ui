# Production / writing by

- Tomoya Fukue (Github : @g495)

react-router-dom, react-twitter-widgets, styled-componentsを導入し、アプリケーションの基礎的な雛形を担当しました。

- Atsuki Tanaka (@AT03wisdom)

福江さんがほとんど作った雛形に、UI調整や並び替えなど多少の加筆をしました。
